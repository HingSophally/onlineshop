...
<nav class="bg-blue-900 border-gray-200 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            @auth
                <div class="flex items-center justify-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                        ...
                        <img class="w-8 h-8 rounded-full" src="https://img.freepik.com/premium-vector/3d-user-login-verification-icon-human-symbol-mobile-ui-ux-app-icons_716564-372.jpg?w=740" alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden my-4 text-base list-none bg-blue-900 divide-y divide-gray-100 rounded-lg shadow " id="user-dropdown">
                        <div class="px-4 py-3">
                        ...
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            <li>
                                <a href="{{'profile'}}" class="block px-4 py-2 text-sm text-white hover:bg-white hover:text-gray-500">Profile</a>
                            </li>
                            <li>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul class="flex text-white flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                <li>
                    <a href="{{'/'}}" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 text-white " >Home</a>
                </li>
                <li>
                    <a href="{{'about'}}" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 " >About</a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{'/category'}}" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Categories</a>
                </li>
                <li>
...
<footer>
    <footer class="bg-blue-900">
        <div class="mx-auto w-full max-w-screen-xl">
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-white md:flex md:items-center md:justify-between">
